...
> the exceptions: **U-001…U-005 are shipped**; **U-006…U-012** are *ready* (measurably behind
...
- **U-005** · `done` · R8,R1 · Ranked top-3 distance-kernel aggregation now
  blends retrieved answers against the model with radius coverage and honest residual
  epistemic. P8 retrieval accuracy improves, P9's retrieval marginal is safe/neutral,
  P10 retains its codec competence gain, and the full P0–P14 ratchet passes.
