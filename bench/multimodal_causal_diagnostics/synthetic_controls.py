"""MM-009-owned pre-real repeated-operator synthetic controls."""
...
from bench.multimodal_causal_diagnostics import predictor, records
...
SCHEMA_VERSION: Final = "mm009-synthetic-controls-v1"
...
class SyntheticControlError(ValueError):
    """Raised when a pre-real MM-009 synthetic expectation fails."""
...
def run_controls(*, config_sha256: str, protocol_sha256: str) -> dict[str, records.JsonValue]:
    ...
    if set(ALL_SEEDS).intersection(synthetic.FROZEN_SEED_MAP.values()):
        raise SyntheticControlError("MM-009 synthetic seeds overlap MM-008 reserved seeds")
