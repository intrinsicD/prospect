"""Fitting-free future-mutation isolation gate for frozen MM-009 predictions.
...
from bench.multimodal_causal_diagnostics import preparation, records

SCHEMA_VERSION: Final = "mm009-future-isolation-v1"
