"""Minimal ``python -I -S`` bootstrap for the fitting-free MM-009 future gate."""
...
def _readable_paths(
    ...
    from bench.multimodal_causal_diagnostics import launcher
...
def main(argv: list[str] | None = None) -> int:
    ...
    from bench.multimodal_causal_diagnostics import launcher, sandbox
    ...
    from bench.multimodal_causal_diagnostics import future_isolation
