"""Sealed shadow-runtime construction and one-row process supervision for MM-011."""
...
SCHEMA_VERSION: Final = "mm011-shadow-runtime-v1"
CUSTODY_SCHEMA_VERSION: Final = "mm011-custody-runtime-v1"
DEPENDENCY_SCHEMA_VERSION: Final = "mm011-numpy-dependency-closure-v1"
DEPENDENCY_SOURCE_SCHEMA_VERSION: Final = "mm011-numpy-dependency-source-v1"
STDLIB_SCHEMA_VERSION: Final = "mm011-stdlib-closure-v1"
STDLIB_SOURCE_SCHEMA_VERSION: Final = "mm011-stdlib-source-v1"
CUSTODY_SOURCE_SCHEMA_VERSION: Final = "mm011-custody-runtime-source-v1"
HOST_TRUST_SCHEMA_VERSION: Final = "mm011-host-runtime-trust-v1"
...
LAUNCHER_RELATIVE: Final = Path("bench/multimodal_causal_assay/launcher.py")
PROBE_RELATIVE: Final = Path("bench/multimodal_causal_assay/probe.py")
FUTURE_ISOLATION_LAUNCHER_RELATIVE: Final = Path("bench/multimodal_causal_assay/future_isolation_launcher.py")
SCORE_LAUNCHER_RELATIVE: Final = Path("bench/multimodal_causal_assay/score_launcher.py")

_COPIED_SOURCES: Final[Mapping[Path, Path]] = {
    Path("bench/multimodal_causal_assay/launcher.py"): Path("bench/multimodal_causal_assay/launcher.py"),
    Path("bench/multimodal_causal_assay/predictor.py"): Path("bench/multimodal_causal_assay/predictor.py"),
    Path("bench/multimodal_causal_assay/preparation.py"): Path(
        "bench/multimodal_causal_assay/preparation.py"
    ),
    Path("bench/multimodal_causal_assay/probe.py"): Path("bench/multimodal_causal_assay/probe.py"),
    Path("bench/multimodal_causal_assay/records.py"): Path("bench/multimodal_causal_assay/records.py"),
    Path("bench/multimodal_causal_assay/sandbox.py"): Path("bench/multimodal_causal_assay/sandbox.py"),
    Path("bench/multimodal_causal_assay/worker.py"): Path("bench/multimodal_causal_assay/worker.py"),
...
_CUSTODY_COPIED_SOURCES: Final[Mapping[Path, Path]] = {
    Path("bench/multimodal_causal_assay/future_isolation.py"): Path(
        "bench/multimodal_causal_assay/future_isolation.py"
    ),
    ...
    Path("bench/multimodal_causal_assay/score_worker.py"): Path(
        "bench/multimodal_causal_assay/score_worker.py"
    ),
    Path("bench/multimodal_causal_assay/scoring.py"): Path("bench/multimodal_causal_assay/scoring.py"),
}
...
def run_isolation_probe(
    ...
    *,
    ...
    if (
        ...
        or value.get("schema_version") != "mm011-isolation-probe-v3"
