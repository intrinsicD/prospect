"""Pure target scoring for frozen MM-011 central predictions.
...
SCHEMA_VERSION: Final = "mm011-scoring-v1"
...
class ScoringError(ValueError):
    """Raised when MM-011 scoring evidence violates the frozen contract."""
...
@dataclass(frozen=True, slots=True)
class RowScores:
    """The exact named MM-011 error primitives for one scored row."""
