"""Standard-library bootstrap for one Landlock/seccomp MM-011 worker."""
...
SCHEMA_VERSION: Final = "mm011-source-launcher-v1"
_ENVIRONMENT: Final = {
    "HOME": "/nonexistent",
    "LC_ALL": "C",
    "MALLOC_ARENA_MAX": "2",
...
# root is *not* one of them: formal MM-011 prepares a separate tree containing only
